...
app = Flask(__name__)
BUILD_VERSION = "ATRIS v1.1-preview11-local-20260919"
...
function openFetchedPage(){if(!pendingPage)return;const page=pendingPage;pendingPage=null;history.pushState({},'',page.url);document.open();document.write(page.html);document.close();}
