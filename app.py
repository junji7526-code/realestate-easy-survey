...
app = Flask(__name__)
BUILD_VERSION = "ATRIS v1.0-preview8-20260914"
...
<div class="scope">{{ '全国｜身近な防災確認' if mode == 'public' else ('愛知・岐阜・三重｜詳しい調査画面' if mode == 'internal' else '愛知・岐阜・三重｜営業現場向け') }}</div>
...
<div class="loan-result" id="loanResult">入力すると毎月の返済額を概算表示します。</div><div class="notice">※元利均等返済による概算です。実際の返済額は金融機関の商品・金利・諸条件により異なります。</div></div>{% endif %}
